...
# class Food24Spider(CrawlSpider):
#     name = "food24"  # The name of the Spider, it will be used to create unique requests and identify the spider
#     allowed_domains = ['food24.com']
#     start_urls =['https://www.food24.com/',
#                  'https://www.food24.com/new-recipes/',
#                  'https://www.food24.com/easy-weekday-meals/',
